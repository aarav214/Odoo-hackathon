  ...
  return (
    <div className="bg-white rounded-3xl border border-[#EDE8E0] warm-shadow card-hover p-5 fade-in-up">
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
        <button className="flex items-center justify-center gap-1 bg-[#7BAE7F] hover:bg-[#5A9260] text-white text-[11px] font-medium py-2 rounded-xl btn-scale">
          <Download size={12} /> Payslip
        </button>
        <button className="flex items-center justify-center gap-1 bg-[#F4EFE7] hover:bg-[#EDE8E0] text-[#2F2A26] text-[11px] font-medium py-2 rounded-xl btn-scale">
