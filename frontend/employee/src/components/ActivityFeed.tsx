...
export default function ActivityFeed({ onTabChange }: { onTabChange?: (tab: string) => void }) {
  ...
  return (
    <div className="bg-white rounded-3xl border border-[#EDE8E0] warm-shadow card-hover p-5 fade-in-up">
      ...
      <button
        ...
        className="mt-3 w-full flex items-center justify-center gap-1.5 text-xs font-medium text-[#7BAE7F] hover:bg-[#7BAE7F10] py-2 rounded-xl transition-colors"
      >
